...
- [Installation](#installation)
  ...
  - [4. Configure API Keys (Optional)](#4-configure-api-keys-optional)
...
- **[Tavily API Key](https://tavily.com/)** for web search capabilities (optional)
...
When prompted, enter your **[Hugging Face Token](https://huggingface.co/settings/tokens)** and optionally your **[Tavily API Key](https://tavily.com/)** for enhanced web search capabilities.

  **Note**:
  - The Tavily API Key is optional but enables advanced web search functionality in your AI agents
